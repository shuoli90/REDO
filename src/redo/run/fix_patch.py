...
if __name__ == '__main__':
    ...
    for idx, ant_prediction in tqdm(enumerate(predicted_results), total=len(predicted_results)):
        ...
        record['model_name_or_path'] = f'{method}_modified'
        modified_records.append(record)

        if idx % 10 == 0:
            with open(f'/home/ubuntu/mnt/agent/amazon-Q/NGDEBirds/NGDEBirdsScienceTransforms/src/birds_transforms/examples/modified_predictions/modified_patches_{method}.jsonl', 'w') as f:
